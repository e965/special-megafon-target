    ...
    questions: [
      {
        ...
        levels: [
          {
            author: '000',
            text: ['Известные предприниматели тоже получают рекламные сообщения. Выберите того, кому могла прийти SMS ниже. Если ошибётесь, придёт вариант попроще.', 'Весь июнь! Скидки на серые футболки до 50% [fakelink|https://we.ar].'],
            answersTexts: {
              zuck: {
                chat: '',
                result: ''
          ...
          {
            author: '000',
            text: 'Скидки на серые футболки. Всем покупателям промокод на курсы кризисного менеджмента [fakelink|https://we.ar].',
            answersTexts: {
              zuck: {
                chat: '',
                result: ''
          ...
          {
            author: '000',
            text: 'Скидки на серые футболки. Всем покупателям промокод на курсы кризисного менеджмента и книги о будущем технологий [fakelink|https://we.ar].',
            answersTexts: {
              bezos: {
        ...
        levels: [
...

          {
            ...
            answersTexts: {
              ...
              gates: {
                result: 'Не доставлено. Биллу Гейтсу ближе благотворительность. Это сообщение для главы Amazon — его компания заменяет складских работников роботами.'
              },
