    ...
    questions: [
      {
        ...
        levels: [
          {
            author: '000',
            text: 'Известные предприниматели тоже получают рекламу. Выберите того, кому могли предложить скидку на серые футболки. Если ошибётесь, придёт SMS попроще',
            answersTexts: {
              zuck: {
                chat: '',
                result: ''
          ...
          {
            author: '000',
            text: 'Скидки на серые футболки. Всем покупателям промокод на курсы кризисного менеджмента.',
            answersTexts: {
              zuck: {
                chat: '',
                result: ''
          ...
          {
            author: '000',
            text: 'Скидки на серые футболки. Всем покупателям промокод на курсы кризисного менеджмента и книги о будущем технологий',
            answersTexts: {
              bezos: {
                result: 'Марк Цукерберг — большой любитель серой одежды. Но с остальным тестом вы точно справитесь.'
              },
        ...
        answersCommonTexts: {
          zuck: {
            chat: '',
            result: 'Теперь вы с тестом точно справитесь.'
          }
        }
      },
