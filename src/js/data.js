        ...
        levels: [
...

          {
            ...
            answersTexts: {
              ...
              gates: {
                chat: 'Мне благотворительность интереснее.',
                result: 'Это сообщение для Джеффа Безоса, главы Amazon.'
              },
        ...
        levels: [
...

          {
            ...
            answersTexts: {
              ...
              brin: {
                chat: 'Не очень хочется поддерживать конкурентов.',
                result: 'Это сообщение для главы Grishin Robotics Дмитрия Гришина — у него есть Tesla.'
              },
        ...
        levels: [
...

          {
            ...
            answersTexts: {
              ...
              cook: {
                chat: 'Наши Apple Card — титановые.',
                result: 'Это сообщение для Николая Сторонского — Revolut выдаёт стальные карты премиальным клиентам.'
              }
            }
          }
        ...
        levels: [
...

          {
            ...
            answersTexts: {
              ...
              tatulova: {
                chat: 'Десять килограммов? Маловато.',
                result: 'Русские блины, клубника и маскарпоне — всё это в «Теремке». Или премиум-блинной «Припёк» от того же основателя.'
              },

              tinkov: {
                chat: 'Ресторанный бизнес для меня давно не в приоритете.',
                result: 'Русские блины, клубника и маскарпоне — всё это в «Теремке». Или премиум-блинной «Припёк» от того же основателя.'
              }
            }
          }
